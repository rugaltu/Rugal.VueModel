System.register(["vue"], function (exports_1, context_1) {
    ...
    return {
        ...
        execute: function () {
            ...
            exports_1("FuncBase", FuncBase);
            //#endregion
            //#region DomQueryer
            QueryNode = class QueryNode extends FuncBase {
                Dom;
                DomName = null;
                Parent = null;
                Children = [];
            ...
            exports_1("ApiStore", ApiStore);
            VueStore = class VueStore extends ApiStore {
                $VueProxy = null;
                $VueOption = {
                    methods: {},
                    components: {},
            ...
            VueModel = class VueModel extends VueCommand {
                ...
                Init() {
                    if (this.$IsInited)
                        return this;
                    this.Store = vue_1.reactive(this.Store);
                    let GetStore = this.Store;
                    let MountedFunc = this.$MountedFuncs;
                    this.$VueApp = vue_1.createApp({
                        ...this.$VueOption,
                        data() {
                            return GetStore;
                        },
