...
export declare class VueCommand extends VueStore {
    ...
    AddV_If(domName: PathType | QueryNode[], option: AddCommandOption | boolean): this;
    AddV_ElseIf(domName: PathType | QueryNode[], option: AddCommandOption | boolean): this;
    AddV_Else(domName: PathType | QueryNode[]): this;
    AddV_Show(domName: PathType | QueryNode[], option: AddCommandOption): this;
    AddV_Bind(domName: PathType | QueryNode[], bindKey: string, option: AddCommandOption | boolean, args?: string): this;
